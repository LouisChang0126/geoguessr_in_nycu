...
def get_prompt():
    ...
    must_NYCU_prompt = 'You are the campus master of National Yang-Ming Chiao Tung University. Please use your expert reasoning and thinking skills to predict which building within the National Yang-Ming Chiao Tung University this photo is taken from. Your answer should be in JSON format, for example: {"country": your_answer}. Please try your best to guess a building. You must provide the building/building name.'
    return {
